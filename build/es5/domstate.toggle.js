(function() {
    ...
    function $$toggle$$init( config ) {
        ...
        var getattr = function(e ) {return e.detail || config.attribute},

            // shortcut to dispatch bubbling events
            dispatch = function(elm, ev, data)  {return elm.dispatchEvent( new CustomEvent(ev, { bubbles: true, detail: data }) )},
            ...
            toggle = function(e ) {return e.target.hasAttribute( getattr(e) ) ? off(e) : on(e)};
